...
const SafetyTabsList = (loading) => {
    ...
    const handleSaveChanges = () => {
        axios.patch(`${api.api}safetyItems/${currentUser._id}`, updatedUser)
            .then(() => {
                fetchAllProducts();
                ...
                <div className="card-body p-0">
                    <div className="table-responsive active-projects style-1 ItemsCheckboxSec shorting">
                        <div className="tbl-caption">
                            <h4 className="heading mb-0">Manpower List</h4>
                            {/* <div>
                            ...
                            <table id="projects-tbl" className="table ItemsCheckboxSec dataTable no-footer mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Safety Item Name</th>
                                        <th>Safety Item Description</th>
                                        <th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
