...
const LeadListPage = () => {
  ...
  return (
    ...
    <Row gutter={[0, 0]} style={{ marginBottom: "10px", padding: "2px"}}>
      ...
      {filteredLeads.map((lead, index) => (
        ...
        <Row gutter={[4, 4]}>
  <Col xs={24} lg={18} style={{ borderRight: "2px solid #ccc", paddingRight: 8 }}>
    <Row gutter={[3, 3]}>
      {[
  ...
  <Col xs={24} lg={6} style={{ paddingLeft: 10 }}>
  <div style={{ borderBottom: "1px solid", paddingBottom: 4 }}>
  <h4 style={{ marginBottom: 2, fontSize: "14px" }}>FROM</h4>
  <p style={{ marginBottom: 1, fontSize: "13px" }}><b>Company:</b> {lead.Company}</p>
  <p style={{ marginBottom: 1, fontSize: "13px" }}><b>Contact:</b> {lead.Name}</p>
  <p style={{ marginBottom: 1, fontSize: "13px" }}><b>Mobile:</b> {lead.Mobile}</p>
  <p style={{ marginBottom: 1, fontSize: "13px" }}><b>Email:</b> {lead.Email || "-"}</p>
  <p style={{ marginBottom: 1, fontSize: "13px" }}><b>Location:</b> {lead.Address}</p>
  <p style={{ marginBottom: 1, fontSize: "13px" }}>
    TO <Button size="small" style={{ float: "right", background: "#5D3FD3", color: "white" }}>+ Assign Lead</Button>
  </p>
  <p style={{ marginBottom: 1, fontSize: "13px" }}>Sandeep, Rahul</p>
  <Space style={{ position: "relative", top: "-3px" }}>
  ...
  <Space style={{ marginTop: 0, position: "relative", top: "-3px" }}>
