...
const ToolForm = forwardRef((props, ref) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(api.api + "tool", employeeData);

            if (response.status === 200) {
                swal("Tool successfully Created");
                setCategoryName('');
                        ...
                        <form>
                            <div className="row">
                                <div className="col-xl-6 mb-3">
                                    <label htmlFor="exampleFormControlInput2" className="form-label">Tool Name <span className="text-danger">*</span></label>
                                ...
                                <div className="col-xl-6 mb-3">
                                    <label htmlFor="exampleFormControlInput3" className="form-label">Tool Description <span className="text-danger">*</span></label>
