...
const ToolListTbl = (loading, setLoading) => {
    ...
    const handleDeleteUser = (productId) => {
        axios.patch(`${api.api}tool/${productId}`)
            .then(() => {
                fetchAllProducts();
            })
            .catch((err) => {
    ...
    const handleSaveChanges = () => {
        axios.patch(`${api.api}tool/${currentUser._id}`, updatedUser)
            .then(() => {
                fetchAllProducts();
                ...
                <div className="card-body p-0">
                    <div className="table-responsive active-projects style-1 ItemsCheckboxSec shorting">
                        <div className="tbl-caption">
                            <h4 className="heading mb-0">Tool List</h4>
                            {/* <div>
