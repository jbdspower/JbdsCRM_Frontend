...
const ManpowerForm = forwardRef((props, ref) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(api.api + "manpower", employeeData);

            if (response.status === 200) {
                swal("Manpower successfully Created");
                setCategoryName('');
                        ...
                        <form>
                            <div className="row">
                                <div className="col-xl-6 mb-3">
                                    <label htmlFor="exampleFormControlInput2" className="form-label">Manpower Name <span className="text-danger">*</span></label>
                                ...
                                <div className="col-xl-6 mb-3">
                                    <label htmlFor="exampleFormControlInput3" className="form-label">Manpower Description <span className="text-danger">*</span></label>
