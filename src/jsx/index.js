...
import Products from './components/AppsMenu/AppProfile/Products';
...
import CreateTicket from "./components/TicketProcess/CreateTicket";
import TicketSummary from "./components/TicketProcess/TicketSummary";
import TicketList from "./components/TicketProcess/TicketList";
import Tool from "./components/ToolMaster/Tool";
import Manpower from "./components/Manpower/Manpower";
import SafetyItems from "./components/SafetyItems/SafetyItems";
import ManageLocation from "./components/Location/LocationDeatils";
import Customer from "./components/Customer/Customer";
import TicketDashboard from "./components/Dashboard/TicketDashboard";
import LeadManagement from "./components/Lead/LeadList";
...
const Markup = () => {
  ...
  const allroutes = [
    ...
    { url: "edit-ticket/:SR_ID", component: <CreateTicket NextStateApi={'nextState'} WorkFlowName={'ticketprocess'} /> },
    { url: "create-ticket", component: <CreateTicket NextStateApi={'nextState'} WorkFlowName={'ticketprocess'} /> },
    { url: "ticket-summary", component: <TicketSummary /> },
    { url: "ticket-list", component: <TicketList /> },
    { url: "leads-list", component: <LeadManagement /> },
    ...
    { url: "product-details", component: <Products /> },
    { url: "tool-details", component: <Tool /> },
    { url: "manpower-details", component: <Manpower /> },
    { url: "safety-details", component: <SafetyItems /> },
    { url: "location-details", component: <ManageLocation /> },
    { url: "customer-details", component: <Customer /> },
